...
var layer = {
  ...
  config: function(options, fn){
    ...
    isLayui 
      ? layui.addcss('css/' + options.extend)
    : layer.link('css/' + options.extend);
  ...
  ready: function(callback){
    ...
    isLayui ? layui.addcss('static/css/layer.css', callback, cssname)
    : layer.link('static/css/layer.css', callback, cssname);
    return this;
  },
